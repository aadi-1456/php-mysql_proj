...
<body>
  ...
  <ul class="">
    ...
    <li class="">
      <a href="#" class="text-light fw-bold">Lab Details</a>
  ...
  <div class="p-4">
    ...
    <section class="charts mt-4">
      ...
      <table class="table table-striped table-dark table-hover">
                ...
                <tbody>
                    <?php
                        $sql = "SELECT *  FROM lab WHERE lab='dbms' AND batch='3'";
    ...
    <section class="charts mt-4">
      <div class="chart-container p-4">
      <div class="content rounded-3 p-3">
        <h1 class="fs-3 text-light">MP Lab Timing & Room Number</h1>
      ...
      <table class="table table-striped table-dark table-hover">
                ...
                <tbody>
                    <?php
                        $sql = "SELECT *  FROM lab WHERE lab='mp' AND batch='3'";
                        $result=mysqli_query($mysql_db,$sql);
                        if($result){
                            while($row=mysqli_fetch_assoc($result)){
                                $teacher=$row['teacher'];
    ...
    <section class="charts mt-4">
      <div class="chart-container p-4">
      <div class="content rounded-3 p-3">
        <h1 class="fs-3 text-light">SS Lab Timing & Room Number</h1>
      ...
      <table class="table table-striped table-dark table-hover">
                ...
                <tbody>
                    <?php
                        $sql = "SELECT *  FROM lab WHERE lab='ss' AND batch='3'";
                        $result=mysqli_query($mysql_db,$sql);
                        if($result){
                            while($row=mysqli_fetch_assoc($result)){
                                $teacher=$row['teacher'];
