...
<body>
  ...
  <ul class="">
    <li class="">
    <a href="batch2.php" class="text-light fw-bold">DashBoard</a>
  ...
  <div class="p-4">
    ...
    <section class="charts mt-4">
      ...
      <table class="table table-striped table-dark table-hover">
                ...
                <tbody>
                    <?php
                        $sql = "SELECT *  FROM lab WHERE lab='dbms' AND batch='2'";
    ...
    <section class="charts mt-4">
      ...
      <table class="table table-striped table-dark table-hover">
                ...
                <tbody>
                    <?php
                        $sql = "SELECT *  FROM lab WHERE lab='mp' AND batch='2'";
                        $result=mysqli_query($mysql_db,$sql);
                        if($result){
                            while($row=mysqli_fetch_assoc($result)){
                                $teacher=$row['teacher'];
    ...
    <section class="charts mt-4">
      ...
      <table class="table table-striped table-dark table-hover">
                ...
                <tbody>
                    <?php
                        $sql = "SELECT *  FROM lab WHERE lab='ss' AND batch='2'";
                        $result=mysqli_query($mysql_db,$sql);
                        if($result){
                            while($row=mysqli_fetch_assoc($result)){
                                $teacher=$row['teacher'];
